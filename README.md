...
│   ├── manifest.json         # PWA manifest (v3.3.1)
...
**Current live version** is in the `docs/` folder (v3.3.1).

### Version History
- **v3.3.1** (Current) - Spirit history now preserves signed energy/mood for quadrant accuracy
