...
**Current live version** is in the `docs/` folder (v3.3.4).

### Version History
- **v3.3.4** (Current) - History date picker holds selected date reliably with local-day formatting
- **v3.3.3** - Sleep duration now respects cross-midnight rest times in scoring and history
