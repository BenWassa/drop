...
// Helper to allow screens to register themselves. Keeps backward compatibility
// with existing code that may call populateCommitmentsScreen directly.
window.registerScreen = function(name, setupFn) {
